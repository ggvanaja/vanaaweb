...
<body>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active" style="width:100%; height:93%;">
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item" style="width:100%; height:93%;">
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item" style="width:100%; height:93%;">
        ...
        <!--banner content-->
        <div id="home" class="banner" style="position: relative; top:-100%; z-index:1; margin-bottom:-41%">
            <div class="banner-info">
                <div class="container">         
                    ...
                    <div class="col-md-8 header-right" style="margin-top:5%; margin-bottom:-5%;">
                        <h2>Hello...</h2>
        ...
        <div id="about" class="about">
            <div class="container">
                <h3 class="title"> About Me</h3><br><br>
        ...
        <div id="work" class="work">
            <div class="container">
                <h3 class="title">Work Experience</h3><br><br>
                <div class="work-info"> 
        ...
        <div id="skills" class="skills">
            <div class="container">
                ...
                <div class="skills-info"><br><br><br><br>
        ...
        <div class="portfolio">
            <div id="projects" class="container">
                <h3 class="title wow zoomInLeft animated" data-wow-delay=".5s">My portfolio</h3><br><br><br><br>
                <div class="sap_tabs">          
